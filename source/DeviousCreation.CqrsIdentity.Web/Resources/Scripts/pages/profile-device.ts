...
export class ProfileDevice {
    private $challenge: HTMLInputElement;
    private $name: HTMLInputElement;
    private $clientData: HTMLInputElement;
    private $registrationData: HTMLInputElement;
    ...
    async startDeviceRegistration(name: string) :Promise<PublicKeyCredentialCreationOptions> {
        let response = await fetch('/api/auth-device/initiate-registration', {
            method: 'POST',
            mode: 'same-origin',
            cache: 'no-cache',
            credentials: 'same-origin',
    ...
    init() {
        this.$challenge = document.querySelector('input[data-challenge]') as HTMLInputElement;
        this.$clientData = document.querySelector('input[data-client-data]') as HTMLInputElement;
        this.$registrationData = document.querySelector('input[data-registration-data]') as HTMLInputElement;
